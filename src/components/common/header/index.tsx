...
const Header = function () {
    ...
    const removeToken = () => {
        sessionStorage.removeItem("agendei-token");
        ...
        <>
            <Container className={styles.header}>
                <Link href="/cliente/inicio">
                    <Image src="/AgendeiLogoColorida.svg" alt="Perfil" className={styles.logo} width={100} height={30} />
                </Link>
                ...
                <ul className={styles.menu}>
                    <li><Link href='/cliente/configurar'>Configurar Conta</Link></li>
                    <hr/>
